...
// <editor-fold desc="Properties">
     ...
     * @return string
     */
    protected function createVendorTxCode(string $ref = '') : string
    {
        $timestamp = date("y-m-d-H-i-s", time());
        $ref === '' ? $suffix = rand(0, 32000) * rand(0, 32000) : $suffix = $ref;
...
// </editor-fold>
     ...
     * @return mixed
     */
    public static function decode(string $strIn) : array
    {
     ...
     * @return string
     */
    public static function decodeAndDecrypt(string $strIn) : string
    {
